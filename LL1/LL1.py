    ...
    def Run(self, new_letter, pos):
        ...
        while self.pos_stack != []:
            ...
            while self.current_pos != "NULL":
                ...
                if new_letter in guides:
                    ...
                    if stack:
                        ...
                        print("Pushed to stack {} position, stack: {}".format(self.current_pos + 1, self.pos_stack))
            ...
            if self.current_pos == "NULL":
                ...
                print("Poped from stack, now at {} position, stack: {}".format(self.current_pos, self.pos_stack))




def Run(rules, lr_letter, ft_letter, show_all = False):
